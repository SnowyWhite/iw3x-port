...
namespace Components
{
	...
	void TeamDumper::DumpTeams()
	{
		const teamDef finalTeams[] = {
			...
			{ "opfor",		 "iw3_opfor_desert",		"opforce_composite","MPUI_OPFOR",		"MPUI_OPFOR_SHORT",		"MP_OPFOR_ELIMINATED",		"MP_OPFOR_FORFEITED",		"faction_128_arab",		"faction_128_arab_fade",	"AB_",	"mp_spawn_opfor",	"mp_victory_soviet",	"prop_flag_opfor",		"prop_flag_neutral",	"objpoint_flag_opfor",			"ui_flagbase_black", {0.6f,  0.57f, 0.41f},		"headicon_opfor",		"com_plasticcase_beige_big", "mp_bog",			{"mptype_axis_sniper",				"mptype_axis_support",			"mptype_axis_rifleman",				"mptype_axis_engineer",				"mptype_axis_cqb",					"mptype_opforce_comp_riot" }},
