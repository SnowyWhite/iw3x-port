...
#pragma pack(pop)
    ...
    struct __declspec(align(4)) WeaponDef
    {
        ...
        Game::IW3::PenetrateType penetrateType;
        weapInventoryType_t inventoryType;
        weapFireType_t fireType;
        OffhandClass offhandClass;
        Game::IW3::weapStance_t stance;
        ...
        int iReticleMinOfs;
        Game::IW3::activeReticleType_t activeReticleType;
        float vStandMove[3];
        float vStandRot[3];
        float strafeMove[3];
        float strafeRot[3];
        ...
        Material* hudIcon;
        Game::IW3::weaponIconRatioType_t hudIconRatio;
        Material* pickupIcon;
        Game::IW3::weaponIconRatioType_t pickupIconRatio;
        Material* ammoCounterIcon;
        Game::IW3::weaponIconRatioType_t ammoCounterIconRatio;
        Game::IW3::ammoCounterClipType_t ammoCounterClip;
        int iStartAmmo;
        ...
        Game::IW3::weapOverlayReticle_t overlayReticle;
        Game::IW3::WeapOverlayInteface_t overlayInterface;
        float overlayWidth;
        float overlayHeight;
        ...
        Game::IW3::weaponIconRatioType_t killIconRatio;
        int iReloadAmmoAdd;
        int iReloadStartAdd;
        ...
        Game::IW3::weapProjExposion_t projExplosion;
	...
	struct  WeaponCompleteDef
    {
        ...
        int iFireTime;
        Game::IW3::weaponIconRatioType_t dpadIconRatio;
